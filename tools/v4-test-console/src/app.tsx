      ...
      <main>
        ...
        {tab === "nfts" ? (
          <section className="panel gated-panel">
            ...
            <span className="eyebrow">Deployment-gated surface</span>
            <h1>Position NFTs are not deployed</h1>
            <p>The current production Engine positions are raw records and do not have ERC-721 ownership or metadata. The console will not fabricate an NFT view or use a planned address. When the Position NFT, router, and lens have a verified deployment manifest, this tab can display them.</p>
            <div className="fact-line"><span>Raw Engine positions</span><b>Available now</b></div>
            <div className="fact-line"><span>NARAPositionNFTV4</span><b>Pending deployment</b></div>
            <div className="fact-line"><span>Basket receipt NFTs</span><b>Basket managers not live</b></div>
          </section>
        ) : null}
      </main>
