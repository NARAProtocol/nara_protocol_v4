            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="p-5 rounded-2xl bg-surface/90 border border-white/10 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 font-mono text-xs">
                  <div className="p-3.5 rounded-xl bg-black/50 border border-white/5 space-y-1">
                    <div className="text-muted text-[10px] uppercase">1 NARA ACTIVE CELL</div>
                  ...
                  <div className="p-3.5 rounded-xl bg-black/50 border border-cyan-400/20 space-y-1">
                    <div className="text-muted text-[10px] uppercase">100 NARA ACTIVE CELLS</div>
                  ...
                  <div className="p-3.5 rounded-xl bg-black/50 border border-white/10 space-y-1">
                    <div className="text-muted text-[10px] uppercase">1,000 NARA ACTIVE CELLS</div>
              ...
              <div className="p-5 rounded-2xl bg-surface/90 border border-white/10 space-y-3">
                <h4 className="font-mono text-xs font-bold text-silver uppercase tracking-wider flex items-center gap-2">
                  ...
                  <span>How Territory Is Joined: Buy & Join The Grid</span>
                </h4>
                <p className="text-dim text-xs leading-relaxed">
                  Holding loose tokens idle in a wallet leaves you off the Sovereign Grid. To join territory, players <strong className="text-white">buy NARA and JOIN THE GRID</strong> inside the autonomous Engine. Joining ignites your coordinates on the map, erects your beacon, and immediately qualifies your position for ongoing 15-minute epoch RESOURCES.
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === "pulse" && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="p-5 rounded-2xl bg-surface/90 border border-white/10 space-y-3">
                ...
                <p className="text-dim text-xs leading-relaxed">
                  Every 15 minutes, the Engine settles an epoch. It distributes rule-based allocations from the sealed 650,000 NARA reserve along with <strong className="text-white">all protocol-generated RESOURCES across the entire ecosystem</strong>:
                </p>
                
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 font-mono text-xs">
                  <div className="p-3 rounded-xl bg-black/40 border border-white/5 space-y-1">
                    <span className="text-cyan-400 font-bold">SWAP VOLATILITY</span>
                    <p className="text-dim text-[11px] font-sans">Dynamic Hook RESOURCES captured from arbitrage & DEX trade volume.</p>
                  </div>
                  <div className="p-3 rounded-xl bg-black/40 border border-white/5 space-y-1">
                    <span className="text-silver font-bold">ETH & TOKEN RESOURCES</span>
                  ...
                  <div className="p-3 rounded-xl bg-black/40 border border-white/5 space-y-1">
                    ...
                    <p className="text-dim text-[11px] font-sans">Singleton flash accounting RESOURCES and future game/ecosystem inflows.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-gradient-to-b from-rose-950/20 to-surface/90 border border-rose-500/20 space-y-3">
                ...
                <ul className="space-y-2.5 text-xs text-silver/80">
                  ...
                  <li className="flex items-start gap-2.5">
                    ...
                    <span>Because the Engine's 15-minute emission rate continues uninterrupted, <strong className="text-emerald-300">the per-tile RESOURCE share of every remaining ACTIVE CELL participant automatically increases</strong>.</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          {activeTab === "roadmap" && (
            <div className="space-y-6 animate-fadeIn">
              <div className="space-y-2">
                ...
                <p className="text-dim">
                  NARA is not an isolated token. It is a multi-layered economic matrix where all future products funnel RESOURCE capture back into ACTIVE CELL holders.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-2xl bg-surface/90 border border-white/10 space-y-2">
                  ...
                  <p className="text-dim text-xs leading-relaxed">
                    100% on-chain SVG machine relics. When participants want liquidity, they do not dump NARA on Uniswap. Instead, they trade their Position NFT on secondary markets. <strong className="text-white">Liquidity is released via DISCONNECT with zero sell pressure on the token.</strong>
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-surface/90 border border-white/10 space-y-2">
                  ...
                  <p className="text-dim text-xs leading-relaxed">
                    Thematic index baskets on Base (CORE, AI, FINANCE, CULTURE). Mint and burn rebalancing RESOURCES and protocol liquidity route directly through NARA, capturing ecosystem volume for the Engine.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-surface/90 border border-white/10 space-y-2">
                  ...
                  <p className="text-dim text-xs leading-relaxed">
                    Dynamic RESOURCE curve capturing arbitrage and swap volatility into protocol reserves. As Protocol-Owned Liquidity (POL) reaches self-sustaining depth, accumulated RESOURCE capture channels directly into ACTIVE CELL allocations.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-surface/90 border border-white/10 space-y-2">
                  ...
                  <p className="text-dim text-xs leading-relaxed">
                    Bonds are built for commitment, not selling. Bond buyers acquire discounted NARA that is delivered pre-joined into vesting Position NFTs, committing supply into the grid rather than creating liquid sell pressure.
                  </p>
                </div>
              </div>
          ...
          {activeTab === "longevity" && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="p-5 rounded-2xl bg-cyan-500/5 border border-cyan-400/20 space-y-2">
                ...
                <p className="text-dim text-xs leading-relaxed">
                  The initial sealed reserve of 650,000 NARA follows an asymptotic epoch decay curve engineered to sustain allocations over years (up to 175,200 commitment epochs). As baseline emissions mature, autonomous RESOURCE capture from the Uniswap v4 Hook, veBaskets, and open reward replenishment (`depositRewards`) transition the Sovereign Grid into a multi-decade self-funding network.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-black/60 border border-white/5 font-mono text-[11px] text-muted space-y-1">
                ...
                <p>
                  NARA Protocol is autonomous, non-custodial software deployed on Base (Chain ID 8453). Rule-based allocations depend on network participation, trading RESOURCES, and time-weighted commitment. There are no guaranteed returns, profits, or interest. VARIABLE NETWORK FLOW depends on participation. All interactions are peer-to-peer and self-directed.
                </p>
              </div>
            </div>
          )}
