...
export const SOCIAL_LINKS = {
  ...
  telegram: "https://t.me/NARA_protocol",
...
export const TELEMETRY_NODES = [
  ...
  },
  {
    ...
    desc: "Time is money. The network calculates and streams RESOURCES directly to committed participants every 15 minutes around the clock.",
  },
  {
    id: "moat",
    label: "03 // THE SACRIFICIAL LAW",
    headline: "Panic Sellers Feed You",
    spec: "Permanent Position Burn · VARIABLE NETWORK FLOW",
    contract: PROTOCOL_CONSTANTS.engineContract,
  ...
  },
  {
    ...
    desc: "Every time traders or arbitrage bots trade NARA, the automated Uniswap v4 hook captures RESOURCES and banks them directly into the protocol treasury.",
  },
];
