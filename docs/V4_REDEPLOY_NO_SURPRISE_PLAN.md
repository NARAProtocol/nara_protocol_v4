...
> **SUPERSEDED — historical planning document.** The fresh v4 Stage A core is
> already deployed. Do not execute this redeploy plan. Current launch scope is
> baskets only; use [CURRENT_STATE.md](CURRENT_STATE.md) and
> [NARA_V4_LAUNCH_RUNBOOK.md](NARA_V4_LAUNCH_RUNBOOK.md).

The material below records the original redeploy plan for historical review. It
